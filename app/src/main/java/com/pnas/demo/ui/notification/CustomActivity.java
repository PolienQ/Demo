package com.pnas.demo.ui.notification;
...
public class CustomActivity extends BaseActivity {
    ...
    public void shwoNotify() {
        ...
        view_custom.setImageViewResource(R.id.custom_icon, R.drawable.umeng_socialize_tx_on);
...
//		view_custom.setTextViewText(R.id.tv_custom_num, num.format(this.number));
        ...
        mBuilder.setContent(view_custom)
                ...
                .setSmallIcon(R.drawable.umeng_socialize_tx_on);
...
//		notify.contentIntent = getDefalutIntent(Notification.FLAG_AUTO_CANCEL);
    ...
    public void showButtonNotify() {
        ...
        mRemoteViews.setImageViewResource(R.id.custom_song_icon, R.drawable.umeng_socialize_twitter);
        ...
        if (android.os.Build.VERSION.SDK_INT <= 9) {
            ...
            //
            if (isPlay) {
                mRemoteViews.setImageViewResource(R.id.btn_custom_play, R.drawable.umeng_socialize_tx_off);
            } else {
                mRemoteViews.setImageViewResource(R.id.btn_custom_play, R.drawable.umeng_socialize_tx_on);
            }
        }
        ...
        mBuilder.setContent(mRemoteViews)
                ...
                .setPriority(Notification.PRIORITY_DEFAULT)// 设置该通知优先级
                .setOngoing(true)
                .setSmallIcon(R.drawable.umeng_socialize_twitter);
        Notification notify = mBuilder.build();
...
//		notify.contentIntent = PendingIntent.getActivity(this, 0, new Intent(), 0);
    ...
    void onClickShowCustom(View view) {
        shwoNotify();
    }

    @OnClick(R.id.btn_show_custom_button)
    void onClickShowCustomButton(View view) {
        showButtonNotify();
    }
