...
public class ProgressActivity extends BaseActivity{
	...
	private void showCustomProgressNotify(String status) {
		...
		mRemoteViews.setImageViewResource(R.id.custom_progress_icon, R.drawable.umeng_socialize_twitter);
...
//			downloadThread.start();
	...
	@OnClick(R.id.btn_show_un_progress)
	void onClickShowUnProgress(View view) {
		downloadThread = null;
		isCustom = false;
		indeterminate = true;
		showProgressNotify();
	...
	@OnClick(R.id.btn_show_custom_progress)
	void onClickShowCustomProgress(View view) {
		downloadThread = null;
		isCustom = true;
		indeterminate = false;
	...
	void onClickDownloadStart(View view) {
		startDownloadNotify();
	}

	@OnClick(R.id.btn_download_pause)
	void onClickDownloadPause(View view) {
		pauseDownloadNotify();
	}

	@OnClick(R.id.btn_download_cancel)
	void onClickDownloadCancel(View view) {
		stopDownloadNotify();
	}
}