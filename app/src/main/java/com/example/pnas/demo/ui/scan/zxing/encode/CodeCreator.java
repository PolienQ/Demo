package com.example.pnas.demo.ui.scan.zxing.encode;
...
public class CodeCreator {
     ...
     */
    public static Bitmap createQRCode(String url, boolean isTransCode) throws WriterException {
